	...
	GeradorDeBoleto.prototype.gerarPDF = function(args) {
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				const ESPACO_ENTRE_LINHAS_TESTE = 95;
//informativo 
				var linha00 = 100;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha00)
					.lineTo(args.ajusteX + 572, args.ajusteY + linha00)
					.stroke(args.corDoLayout2);

				var linha01 = linha00 + ESPACO_ENTRE_LINHAS_TESTE; //ESPACO_ENTRE_LINHAS;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha01)
					.lineTo(args.ajusteX + 572, args.ajusteY + linha01)
					.stroke(args.corDoLayout2);
	


				var coluna01 = 27;
				pdf.moveTo(args.ajusteX + coluna01, args.ajusteY + linha00 - 0.5)
					.lineTo(args.ajusteX + coluna01, args.ajusteY + linha01 - 0.5)
					.stroke(args.corDoLayout2);

				var coluna02 = 572;
				pdf.moveTo(args.ajusteX + coluna02, args.ajusteY + linha00)
					.lineTo(args.ajusteX + coluna02, args.ajusteY + linha01 + 0.5)
					.stroke(args.corDoLayout2);


// fim informativo
// Primeiro bloco de layout
				var linha1 = 225;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha1)
					.lineTo(args.ajusteX + 572, args.ajusteY + linha1)
					.stroke(args.corDoLayout3);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha3)
					...
					.stroke(args.corDoLayout3);
//
				var linhaNova1 = linha3 + ESPACO_ENTRE_LINHAS;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaNova1)
					.lineTo(args.ajusteX + (banco.exibirReciboDoPagadorCompleto() ? 572 : 329), args.ajusteY + linhaNova1)
					.stroke(args.corDoLayout2);

				var linhaNova2 = linhaNova1 + ESPACO_ENTRE_LINHAS;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaNova2)
					.lineTo(args.ajusteX + (banco.exibirReciboDoPagadorCompleto() ? 572 : 329), args.ajusteY + linhaNova2)
					.stroke(args.corDoLayout2);	


				var linhaNova3 = linhaNova2 + ESPACO_ENTRE_LINHAS;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaNova3)
					.lineTo(args.ajusteX + (banco.exibirReciboDoPagadorCompleto() ? 572 : 329), args.ajusteY + linhaNova3)
					.stroke(args.corDoLayout2);	


				var linhaNova4 = linhaNova3 + 80;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaNova4)
						.lineTo(args.ajusteX + (banco.exibirReciboDoPagadorCompleto() ? 572 : 329), args.ajusteY + linhaNova4)
						.stroke(args.corDoLayout2);				


				var linhaNova5 = linhaNova4 + 57;
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaNova5)
						.lineTo(args.ajusteX + (banco.exibirReciboDoPagadorCompleto() ? 572 : 329), args.ajusteY + linhaNova5)
						.stroke(args.corDoLayout2);		
					...
					var coluna0001 = 154;
					pdf.moveTo(args.ajusteX + coluna0001, args.ajusteY + linha01 + 5.5)
						.lineTo(args.ajusteX + coluna0001, args.ajusteY + linha1)
						.stroke(args.corDoLayout5);

						var coluna0002 = coluna0001 + 41.5;
						pdf.moveTo(args.ajusteX + coluna0002, args.ajusteY + linha01 + 5.5)
							.lineTo(args.ajusteX + coluna0002, args.ajusteY + linha1)
							.stroke(args.corDoLayout5);		
// Linha de baixo 
				if (banco.exibirReciboDoPagadorCompleto()) {
					...
					pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha4Opcional)
						...
						.stroke(args.corDoLayout1);
				}
//
				var coluna1 = 27;
				pdf.moveTo(args.ajusteX + coluna1, args.ajusteY + linha1 - 0.5)
					.lineTo(args.ajusteX + coluna1, args.ajusteY + linhaNova5 + 0.5)
					//.lineTo(args.ajusteX + coluna1, args.ajusteY + (banco.exibirReciboDoPagadorCompleto() ? linha4Opcional : linhaNova4) + 0.5)
					.stroke(args.corDoLayout4);
				...
				pdf.moveTo(args.ajusteX + coluna5, args.ajusteY + linha1 - 0.5)
					.lineTo(args.ajusteX + coluna5, args.ajusteY + (banco.exibirReciboDoPagadorCompleto() ? linhaNova4 : linhaNova3) + 0.5)
					.stroke(args.corDoLayout4);
				...
				var margemDaLinhaSeparadora = 15,
					divisoresVerticais = (linhaNova5) + (2 * margemDaLinhaSeparadora) - 4,
				...
				var linhaSeparadora = ( linhaNova5) + margemDaLinhaSeparadora;
				...
				pdf.font('negrito')
					...
					.text('Recibo do Pagador', args.ajusteX + margemDoSegundoBlocoLayout + 145, args.ajusteY + segundaLinha3, {
						lineBreak: false,
						width: 400,
						align: 'right'
					});
				...
				banco.getImprimirNome() && pdf.font('negrito')
					...
					pdf.image(banco.getImagem(), args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + segundaLinha3 - 5, {
						height: alturaDoLogotipoDoBanco
					});
					...
					banco.getImprimirNome() && pdf.font('negrito')
						...
						pdf.font('negrito')
						.fontSize(args.tamanhoDaLinhaDigitavel)
						.text(banco.getNumeroFormatadoComDigito(), args.ajusteX + margemDoSegundoBlocoLayout + 131, args.ajusteY + segundaLinha3, {
							lineBreak: false,
							width: 39.8,
							align: 'center'
