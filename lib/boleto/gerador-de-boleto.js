      ...
      for (const [indice, boleto] of boletos.entries()) {
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + colunaLateral,
            args.ajusteY + tituloDaNonaLinhaLateral1 + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + colunaLateral,
            args.ajusteY + tituloDaDecimaPrimLinhaLateral1 + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          ...
          .text(
            boleto.getValorMoraMultaJurosFormatadoBRL(),
            args.ajusteX + colunaLateral,
            args.ajusteY + tituloDaNonaLinhaLateral + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          ...
          .text(
            boleto.getValorCobradoFormatadoBRL(),
            args.ajusteX + colunaLateral,
            args.ajusteY + tituloDaDecimaPrimLinhaLateral + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
