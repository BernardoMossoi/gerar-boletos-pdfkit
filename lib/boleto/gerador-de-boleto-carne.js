...
class GeradorDeBoletoCarne {
  ...
  gerarPDF(args) {
    return new Promise(async (resolve) => {
      ...
      let contador = 1;
      let ajusteYInicial = args.ajusteY; 
      let espacamentoEntreBoletos = 260; 

      for (const [indice, boleto] of boletos.entries()) {
        
        args.ajusteY = ajusteYInicial + (contador - 1) * espacamentoEntreBoletos;
        // DESENHAR LAYOUT
        ...
        pdf
          ...
          var linha10 = linha9 + ESPACO_ENTRE_LINHAS;
          pdf
            .moveTo(args.ajusteX + 15, args.ajusteY + linha10)
            .lineTo(args.ajusteX + 130, args.ajusteY + linha10)
            .stroke(args.corDoLayout);
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            boleto.getValorMoraMultaJurosFormatadoBRL(),
            args.ajusteX + margemDoSegundoBlocoLayout,
            args.ajusteY + linha6 + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            boleto.getValorCobradoFormatadoBRL(),
            args.ajusteX + margemDoSegundoBlocoLayout,
            args.ajusteY + linha8 + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text('Pagador', args.ajusteX + 20, args.ajusteY + linha10, {
            lineBreak: false,
            width: 294,
            align: 'left',
          });
        ...
        pdf
          .font('normal')
          .fontSize(args.tamanhoDaFonte - 1)
          .text(
            beneficiario.getIdentificacaoCompleta(),
            args.ajusteX + margemDoSegundoBlocoLayout + 175,
            args.ajusteY + Layout2linha1,
            {
              lineBreak: false,
              width: 285,
        ...
        pdf
          ...
          .text(
            boleto.getValorMoraMultaJurosFormatadoBRL(),
            args.ajusteX + colunaLateralDireita,
            args.ajusteY + Layout2linhaLateral2 + 7,
            {
              lineBreak: false,
              width:tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            boleto.getValorCobradoFormatadoBRL(), // Exibe apenas se o valor for válido
            args.ajusteX + colunaLateralDireita,
            args.ajusteY + Layout2linhaLateral4 + 7,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
              align: 'right',
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + colunaLateralDireita + 12,
            args.ajusteY + Layout2linhaLateral6 +7 ,
            {
              lineBreak: false,
              width: tamanhoDasCelulasADireita,
             align: 'left',
        ...
        if (contador === 3 && indice < boletos.length - 1) {
          pdf.addPage(); 
          pdf.undash();
          contador = 1; 
          args.ajusteY = ajusteYInicial;
        } else {
          pdf.undash();
          contador++;
        }
