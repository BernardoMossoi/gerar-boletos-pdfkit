...
class GeradorDeBoletoCarne {
  ...
  gerarPDF(args) {
    return new Promise(async (resolve) => {
      ...
      for (let i = 0; i < boletos.length; i += 3) {
        const boletosPagina = boletos.slice(i, i + 3);
   boletosPagina.forEach((boleto, index) => {

        const offsetY = index * (args.alturaDaPagina / 3); 
      ...
      //   const codigoDeBarras = boleto._codigoBarras;
        ...
        pdf
          ...
          .moveTo(args.ajusteX + camposLaterais, args.ajusteY + Layout2linhaLateral4)
        ...
        var linhaSeparadora =
          Layout2linhaLateral6 + margemDaLinhaSeparadoraCorte + 15;
        ...
        const logoSupeirior = zeroLinha - 20.25;
        const logoSupeirior1 = zeroLinha1 - 20.25;
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + margemDoSegundoBlocoLayout + 135 + 75,
            args.ajusteY + Layout2linha2 + 10,
            {
              lineBreak: false,
              width: 84,
        ...
        pdf
          ...
          var tituloEspecieDoc = tituloNumeroDoDocumento + 50;
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text(
        ...
        var tituloAceite = tituloEspecieDoc ;
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text(
        ...
        //     .font('normal')
        //     .fontSize(args.tamanhoDaFonte)
        //     .text('', args.ajusteX + tituloCip, args.ajusteY + Layout2linha3, {
        //       lineBreak: false,
        //       width: 31,
        //       align: 'center',
        //     });
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + margemDoSegundoBloco + 135 + 65,
            args.ajusteY + Layout2linha3 + 10,
            {
              lineBreak: false,
              width: 71,
        ...
        var tituloQuantidadeMoeda = tituloEspecieMoeda + 30;
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text(
        ...
        var tituloValorMoeda = tituloQuantidadeMoeda + 55;
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text(
        ...
        //   .text(
        //     titulos.agenciaECodigoDoBeneficiario,
        //     args.ajusteX +  margemDoSegundoBlocoLayout + 200,
        //     args.ajusteY + Layout2linha1,
        //     {
        //       lineBreak: false,
        //       width: tamanhoDasCelulasADireita,
        ...
        pdf
          ...
          .text(
            boleto.getValorDeducoesFormatadoBRL(),
            args.ajusteX + colunaLateralDireita,
            args.ajusteY + Layout2linhaLateral1 + 10,
            {
              lineBreak: false,
              width: 294,
              align: 'left',
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + margemDoSegundoBlocoLayout + 135,
            args.ajusteY + Layout2linhaLateral5 + 10,
            {
              lineBreak: false,
              width: 294,
              align: 'left',
        ...
        pdf
          ...
          .text(
            i25(codigoDeBarras),
            args.ajusteX + margemDoSegundoBlocoLayout + 135,
            args.ajusteY + Layout2linhaLateral6 + 3.5,
            {
              lineBreak: false,
              width: 340,
              align: 'left',
