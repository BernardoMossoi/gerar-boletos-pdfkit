  ...
  gerarBoleto() {
    ...
    for (const boleto of this.boletos) {
      ...
      const boletoInfo = Boleto.Boleto.novoBoleto()
        ...
        .comValorDescontos(boleto.boleto.valorDescontos? parseFloat(boleto.boleto.valorDescontos).toFixed(2): 0)
        .comValorMoraMultaJuros(boleto.boleto.ValorMoraMultaJuros? parseFloat(boleto.boleto.ValorMoraMultaJuros).toFixed(2): 0)
        .comIdUnico();
